...
| 原则 | 核心思想 |
| :--- | :--- |
| **1. 成为勤勉、尊重和有爱心的管家** | 对项目内外的资产、资源和关系负责，做出基于诚信、关心和可信的决策。 |
| **2. 创建协作的项目团队环境** | 建立并维护一个协作、尊重、安全的团队文化，赋能团队共同创造价值。 |
| **3. 有效地与干系人互动** | 主动识别、理解并引导干系人参与，以最大化支持并最小化阻力。 |
| **4. 专注于价值** | 将所有项目活动与可交付成果所能实现的商业价值紧密对齐，并持续评估。 |
| **5. 识别、评估和响应系统交互** | 具备整体观，将项目视为一个复杂的系统，理解各部分之间的动态交互。 |
| **6. 展现领导力行为** | 任何团队成员都可以展现领导力。通过影响、激励和指导来赋能团队。 |
| **7. 根据环境进行裁剪** | “没有最好的，只有最合适的”。根据项目独特性裁剪开发方法、过程和工件。 |
| **8. 将质量融入过程和可交付成果** | 质量是所有人的责任。将质量要求嵌入到所有工作流程中，预防胜于检查。 |
| **9. 驾驭复杂性** | 主动识别和应对由人类行为、系统行为和模糊性带来的复杂性。 |
| **10. 优化风险应对** | 主动管理风险，既要最小化威胁，也要最大化机会。 |
| **11. 拥抱适应性和韧性** | 具备从变化和挫折中快速恢复和调整的能力，拥抱变化而非固守计划。 |
| **12. 为实现预期的未来状态而驱动变革** | 项目本身就是变革。主动管理变革过程，帮助干系人从当前状态过渡到未来状态。 |
