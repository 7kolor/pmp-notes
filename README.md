...
我们已将所有PMP知识点重构为以下 **17个核心笔记文件**，建议您按照以下顺序进行学习：
...
11. **[12-考前冲刺核心速记.md](notes/12-考前冲刺核心速记.md)**
    - **用途**: **考前24小时救命锦囊**。高度浓缩的底层逻辑、必考公式、高频考点和答题“红绿灯”技巧，专为考前快速建立题感、查漏补缺设计。

12. **[13-Scrum冲刺流程详解.md](notes/13-Scrum冲刺流程详解.md)**
    - **用途**: 敏捷专题详解。详细解析Scrum框架中的角色、事件、工件，是理解敏捷运作机制的关键。

13. **[14-PMP易错点与解题思维模型.md](notes/14-PMP易错点与解题思维模型.md)**
    - **用途**: **考前纠偏指南**。针对做题时的常见思维误区、逻辑漏洞进行深度剖析，提供万能解题模型和易混概念辨析，助您规避陷阱。

14. **[15-PMP查缺补漏与高频盲点.md](notes/15-PMP查缺补漏与高频盲点.md)**
    - **用途**: **隐形失分点扫雷**。针对EVM指标深层含义、工具混淆矩阵（数据收集vs表现）、职业道德等容易被忽视但必考的盲区进行专项补强。

### 阶段五：核心教材精解 (选读)

这部分是对PMP三大知识来源的详细解读，当您在学习中遇到特定概念需要追本溯源时，可以查阅这部分内容。

15. **[09-PMBOK6与过程组-精解.md](notes/09-PMBOK6与过程组-精解.md)**
    - **用途**: 过程驱动的“武功招式”。详细梳理了五大过程组、十大知识领域及49个过程，是理解预测型项目管理方法的基石。

16. **[10-PMBOK7-精解.md](notes/10-PMBOK7-精解.md)**
    - **用途**: 原则驱动的“心法”。深入解读了指导项目管理思维方式的12大原则和8大绩效域。

17. **[11-敏捷实践指南-精解.md](notes/11-敏捷实践指南-精解.md)**
