...
我们已将所有PMP知识点重构为以下 **16个核心笔记文件**，建议您按照以下顺序进行学习：
...
11. **[14-Scrum冲刺流程详解.md](notes/14-Scrum冲刺流程详解.md)**
    - **用途**: 敏捷专题详解。详细解析Scrum框架中的角色、事件、工件，是理解敏捷运作机制的关键。

### 阶段四：考前终极冲刺

12. **[16-PMP查缺补漏与高频盲点.md](notes/16-PMP查缺补漏与高频盲点.md)**
    - **用途**: **隐形失分点扫雷**。针对EVM指标深层含义、工具混淆矩阵（数据收集vs表现）、职业道德等容易被忽视但必考的盲区进行专项补强。

13. **[15-PMP易错点与解题思维模型.md](notes/15-PMP易错点与解题思维模型.md)**
    - **用途**: **考前纠偏指南**。针对做题时的常见思维误区、逻辑漏洞进行深度剖析，提供万能解题模型和易混概念辨析，助您规避陷阱。

14. **[13-考前冲刺核心速记.md](notes/13-考前冲刺核心速记.md)**
